...
CREATE TABLE IF NOT EXISTS `acolhimento`.`paciente` (
  ...
  CONSTRAINT `fk_paciente_profissao1`
    FOREIGN KEY (`profissao_cbo`)
    REFERENCES `acolhimento`.`profissao` (`cbo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
